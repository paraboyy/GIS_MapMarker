        ...
        <div id="page-inner" class="row">
            ...
            <div class="container mt-5">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form action="{{ route('marker.add') }}" method="post">
                            @csrf
            ...
            <script>
                ...
                <?php foreach ($markers as $marker) { ?>
                    ...
                    switch ("<?= $marker->kategori ?>") {
                        case 'Universitas':
                            iconUrl = "{{ asset('assets/img/university.svg') }}"; // univ icon
                            break;
                        case 'Rumah Sakit':
                            iconUrl = "{{ asset('assets/img/hospital.svg') }}"; // rumah sakit icon
                            break;
                        case 'Bandara':
                            iconUrl = "{{ asset('assets/img/airport.svg') }}"; // rumah sakit icon
                            break;
                        default:
                            iconUrl = "{{ asset('assets/img/park.svg') }}"; //Default Icon
                    }
